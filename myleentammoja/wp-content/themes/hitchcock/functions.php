...
function hitchcock_load_style() {
	if ( !is_admin() ) {
	    wp_enqueue_style( 'hitchcock_googleFontsMontserrat', '//fonts.googleapis.com/css?family=Montserrat:400,700|Droid+Serif:400,400italic,700,700italic' );
	    wp_enqueue_style( 'hitchcock_googleFontsNothing', '//fonts.googleapis.com/css?family=Nothing+You+Could+Do' );
	    wp_enqueue_style( 'hitchcock_googleFontsShadows', '//fonts.googleapis.com/css?family=Shadows+Into+Light' );
...
function hitchcock_add_editor_styles() {
    ...
    $font_url = '//fonts.googleapis.com/css?family=Nothing+You+Could+Do';
    $font_url = '//fonts.googleapis.com/css?family=Shadows+Into+Light';
